...
function Opportunity({data}){
   ...
   <div className="Simplilearn">
       <img src={user.userData.profile.type_id=="3"?data.user.profile.club_logo:data.user.image} alt="Img" style={{height:"50px", width:"50px", borderRadius:"50%",backgroundColor:'#213555'}}/>
       <p className='post-username'>{user.userData.profile.type_id=="3"?data.user.profile.club_name:data.user.user_name} <br /> 
