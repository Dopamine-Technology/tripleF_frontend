...
const Header = ({ content }) => {
    return (
        <div className='whole-div'>
            ...
            <Row style={{ marginRight: '6rem', position: 'relative', zIndex: 2 }}> {/* Ensure content is above the overlay */}
                <NavBar content={content} />
            </Row>
            <Row className='header-row' style={{ position: 'relative', zIndex: 2 }}> {/* Ensure content is above the overlay */}
